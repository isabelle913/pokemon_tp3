<template>
  <div class="grid grid-cols-12 h-32 w-full p-2 justify-start cursor-pointer sm:shadow" @click="goToDetails(pokemon.id)">
    <div class="col-span-2 h-24">
      <img class="" :src="pokemon.img" />
    </div>

    <div class="col-span-4 text-3xl font-medium flex justify-center items-center">
